...
public class TargetPearl extends Module {
    ...
    private void throwPearlToLocation(Vec3d targetLocation) {
        ...
        IntStream.range(-89, 89).mapToObj(pitch -> {
            ...
            TurnsConnection.INSTANCE.rotateTo(new Turns.VecRotation(angle, angle.toVector()), mc.player, 1, new TurnsConfig(new LinearConstructor(), true, true), TaskPriority.HIGH_IMPORTANCE_3, this);
