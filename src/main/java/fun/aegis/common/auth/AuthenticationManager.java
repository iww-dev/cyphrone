...
public class AuthenticationManager {
    private static final String FIREBASE_API_KEY = "If you read this, you are gay";
    private static final String FIREBASE_PROJECT_ID = "Nigger";
    private static final String FIREBASE_DB_URL = "https://Nigger-default-rtdb.firebaseio.com";
    ...
    public AuthenticationManager() {
        File clientDir = new File(MinecraftClient.getInstance().runDirectory, "Cyphrone");
    ...
    public boolean register(String username, String password) {
        try {
            ...
            signUpRequest.addProperty("email", username + "@cyphrone.local");
    ...
    public boolean login(String username, String password) {
        try {
            ...
            signInRequest.addProperty("email", username + "@cyphrone.local");
